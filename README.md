...
## 🎯 Сейчас в фокусе
  ✅ Как выяснилось Владивосток и Азия у нас в основном работает с Vue.js, поэтому я активно изучаю Vue. Погружаюсь в Docker (есть проект, где разработка с ним). Изучаю TypeScript.  
  🚀 1. Продолжаю работу над сайтом фокспринт.рф. Здесь работа сейчас больше по SEO и для него. В проект добавлены url для каждого блока, с помощью vite-prerender-plugin-static настроены теги на каждый блок, добавлен sitemap, robot.txt. Все залито в Яндекс.Вэбмастер и Google Search Console. Жду когда сервисы обновят данные. Посмотрим выдачу. Изучаю как еще повысить позиции (контент релевантен). В планах добавить на сайт отзывы клиентов, пока собираем их.
  2. Вступила некоммерческий проект Hexlet CV. Сделала свой первый компонент. Разобарлась с Моками. Жду ответа от наставника об ошибках. Разбираюсь, тренируюсь работать в комманде.
